...
#define CUSTOM_MACHINE_NAME "Reach 3D"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT  {80, 80 , 1518 , 90 , 1518 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25, 5 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 50, 10000, 50 }
...
//#define Z_PROBE_OFFSET_FROM_EXTRUDER 0.06   // Z offset: -below +above  [the nozzle]
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 X0 Y0 F3000"
...
#define HOMING_FEEDRATE_Z  (16*30)
